INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('does this work','List displays (aka list comprehensions) have proven to be a useful and popular part of Python. However, there are limitations on what they can do, and they sometimes lead to inefficiencies: it is tempting to create a list of intermediate results, even when the whole list is not really needed. Consider finding the maximum termperature over the last day, where you have a function, temp, that takes an hour as argument and fetches the temperature. ', 'first writer', '1987-08-21');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('about tags','Following are some reasons why tags are useful:
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('About history','Gilgamesh is the main character from the Epic of Gilgamesh, an old Akkadian poem that is considered to be the oldest great work of literature in human history.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Do ISPs Track and Sell Your Browsing Data?','Whether or not your data is being sold largely depends on your location. If you’re in a country that’s a member of the European Union, for example, you don’t have to worry. The General Data Protection Regulation expressly forbids your ISP from even collecting your data without your express permission, let alone selling it.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('How to Use and Edit Autofill for Forms in Firefox', 'Whether you choose to save addresses, payment methods, or both, you can speed up form entry using your web browser’s autofill settings.To use the autofill feature in Firefox, you must first enable it. And luckily, you can enable it for addresses and credit cards separately. This is convenient if you prefer not to use it for one or the other.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Samson Q9U Broadcast Mic Review','Researching and investing in audio products is one of the greatest hurdles for amateur podcasters and streamers. But Samson is offering an affordable, low-effort entry point to the world of high-quality audio with its $200 Q9U broadcast mic. With excellent noise rejection and options for USB-C or XLR connections, the Q9U is one of the best entry-level mics available today.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Galactic Starcruiser in 2022',' Disney just dropped the jaws of every Star Wars fan with a new “real” lightsaber.Today and tomorrow, Disney’s Hollywood Studios is offering special Star Wars-themed desserts and beverages available at select locations throughout the park, including the new Dark Side Chocolate Creation and returning favorite Lightsaber Churro. Also, through tomorrow, Disney Springs will offer the Grogu Mini Dome Cake at Amorette’s Patisserie and the Millennium Falcon Chocolate Pop at The Ganachery.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Samsung Just Ended Support for Your Galaxy S8 Device','Four years after their release, Samsung is ending software support for the Galaxy S8 and S8+ smartphones.Samsung launched the Galaxy S8 and S8+ in 2017. At that time, they were some of the most revolutionary devices in Samsung’s lineup. They were the first S-series devices to ditch the home button, and their slick, nearly bezel-free design is still a major element of Samsung’s signature style.', 'ANDREW HEINZMAN', '2021-05-04');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Dell Patched a Critical Driver Flaw from 2009 Affecting Hundreds of PC Models','If you or anyone you know has a Dell computer, old or new, they should probably update it right away. Dell just released a security patch that addresses multiple vulnerabilities in hundreds of its computers dating back to 2009.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('The 10 Best Monitor Riser Stands','If you have a desktop computer, you need a monitor riser stand. Not only will it give you extra space on your desk, but a monitor stand will also help reduce neck strain because the screen will be at a more ergonomic viewing height. Who doesn’t want to be more comfortable at their desk for long hours? There are plenty of monitor riser stands out there. But how do you find the one that’s right for you? Here are a few key things to consider when choosing your monitor riser stand.', 'SARAH CHANEY ', '2021-05-03');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Microsoft is Killing the Adobe Flash Plugin on Windows 10','After stripping Flash from its Reader and Acrobat PDF programs in November, and officially cutting off support for it in January, Adobe will now be removing its Flash Player plugin from Windows 10 starting in July.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('From the Top.The software industry is always changing.','Fortunately for a person interested in entering one of these new software development fields, the technology is so new that years of experience aren’t always a prerequisite. Being able to demonstrate even a cursory ability level may be enough to get started.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('env0 Extends Infrastructure ','env0, a provider of automated, collaborative remote-run workflow management for cloud deployments, today announced its advanced Infrastructure as Code Automation Platform with all-new Custom Flows feature.', 'Unknown', '2021-04-28');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Magic Software Introduces FactoryEye','FactoryEye leverages Magic Software’s four decades of industry knowledge, integration technologies and deployment of mission-critical systems to thousands of companies around the globe. FactoryEye leverages Magic Softwares four decades of industry knowledge, integration technologies and deployment of mission-critical systems to thousands of companies around the globe. With pre-established integration partnerships with leading ERP, CRM and PLM vendors and advanced analytics, FactoryEye ensures that key performance indicators are continuously monitored and reported in real time with cross-company data visibility.', 'Software Magazine', '2021-04-19');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('SmartBear Expands Support of Codeless, Automated Testing for Mobile and ERP Applications','SmartBear, a leading provider of software development and quality tools, has integrated TestComplete, its UI test automation tool, with BitBar, its native mobile device cloud. SmartBear solutions include modern technologies around API lifecycle management, test automation, test management, performance optimization, and collaboration. These solutions are used by leading organizations to enable the design, development, and release of higher-quality software at scale.', 'Software magazine', '2021-04-14');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('NASDAQ: PEGA','As digital expectations continue to skyrocket, organizations are turning to process automation to more efficiently assist their employees and customers. ', 'Pega', '2021-04-14');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Catchpoint Releases Enhanced Version of the WebPageTest API','We’re thrilled to make the WebPageTest API available to the entire development community', 'Patrick Meenan', '2021-04-06');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Applitools Announces Future of Testing','Applitools, provider of a next generation test automation through Visual AI and Ultrafast Test Cloud, today announced “Future of Testing: Mobile,” a free, live-streamed virtual event dedicated to the current trends and innovations shaping mobile test automation.', 'Paulina Grigonis', '2021-04-01');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Code Complete 2 ',' the Joy of Cooking for software developers. Reading it means that you enjoy your work, you''re serious about what you do, and you want to keep improving. In Code Complete, Steve notes that the average programmer reads less than one technical book per year. The very act of reading this book already sets you apart from probably ninety percent of your fellow developers. In a good way.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('About Face: The Essentials of Interaction Design','About Face is full of generally applicable guidelines for mobile and web.Of the GUI problems used for illustration – with examples from the hoary old Windows 95 UI – it''s interesting to compare which have been mostly resolved (using visual examples to show the effects of dialog selections before you make them), and which have not (stopping the proceedings with modal idiocy).
Its a fantastically useful book; Ive used whole chapters as guides for projects I worked on.', 'Alan Cooper', '2017-10-06');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('The Inmates Are Running the Asylum',' Would our users want a print preview feature? Who knows? But if Gerry Manheim, Account Executive, has to print out his weekly expense report as a part of his job, you better believe print preview needs to be in there. Theres nothing magical here; as always, it boils down to knowing who your users are and what they really do – and the personas technique is a great way to get there.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Designing Web Usability','Designing Web Usability is of course a full-on web usability primer, so it''s a bit different than the GUI-oriented Cooper books.', 'Jacob Nielsen', '2019-04-04');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('The Visual Display of Quantitative Information','Information is beautiful. And so is a well-designed GUI.', 'Chris Sells', '2004-06-05');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Regular Expressions Cookbook','UNIX has a well-deserved reputation for being complex and impenetrable. So do Regular Expressions.I may be a card carrying member of the "Keep It Simple Stupid" club, but I''m making a meteor sized exception for regular expressions. Written properly, they will save you a tremendous amount of time in string manipulation, and I''ve never run across a project where they didn''t come in handy somewhere.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('HASH: a free, online platform for modeling the world','Sometimes when you’re trying to figure out the way the world works, basic math is enough to get you going. If we increase the hot water flow by x, the temperature of the mixture goes up by y.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('The Law of Leaky Abstractions','There’s a key piece of magic in the engineering of the Internet which you rely on every single day. It happens in the TCP protocol, one of the fundamental building blocks of the Internet.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Craftsmanship','Making software is not a manufacturing process. In the 1980s everyone was running around terrified that Japanese software companies were setting up “software factories” that could churn out high quality code on an assembly line. It didn’t make any sense then and it doesn’t make sense now. Shoving a lot of programmers into a room and lining them up in neat rows did not really help get the bug counts down.
...
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Biculturalism','By now, Windows and Unix are functionally more similar than different. They both support the same major programming metaphors, from command lines to GUIs to web servers; they are organized around virtually the same panoply of system resources, from nearly identical file systems to memory to sockets and processes and threads. There’s not much about the core set of services provided by each operating system to limit the kinds of applications you can create.', 'LIAN PAU', '2003-05-05');
INSERT INTO POST(TITLE, BODY, AUTHOR,PUBLISHED_ON) VALUES ('Making Wrong Code Look Wrong','When you start out as a beginning programmer or you try to read code in a new language it all looks equally inscrutable. Until you understand the programming language itself you can’t even see obvious syntactic errors.
